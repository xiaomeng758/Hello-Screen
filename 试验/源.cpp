 ...
 CMyTaskSchedule::CMyTaskSchedule()
{
    ...
    //if (FAILED(hr))
   // {
    //    MessageBoxA(NULL, "初始化COM接口环境失败!", "Error", MB_OK);
   //     return;
   // }
   ...
   // if (FAILED(hr))
   // {
   //     MessageBox(NULL, "创建任务服务对象失败!", "Error", MB_OK);
   //     return;
   // }
    ...
    //if (FAILED(hr))
  //  {
    //    MessageBox(NULL, "连接到任务服务失败!", "Error", MB_OK);
   //     return;
    //}
    ...
    hr = m_lpITS->GetFolder(_bstr_t("\\"), &m_lpRootFolder);
       // if (FAILED(hr))
       // {
        //    MessageBox(NULL, "获取根任务的指针失败!", "Error", MB_OK);
        //    return;
        //}
}
...
BOOL CMyTaskSchedule::NewTask(char* lpszTaskName, char* lpszProgramPath, char* lpszParameters, char* lpszAuthor)
{
    ...
    //if (FAILED(hr))
    //{
    //    MessageBox(NULL, "创建任务失败!", "Error", MB_OK);
    //    return FALSE;
    //}
    //设置注册信息
   ...
   // if (FAILED(hr))
    //{
    //    MessageBox(NULL, "设置注册信息失败!", "Error", MB_OK);
   //     return FALSE;
   // }
    // 设置作者信息
    ...
    //if (FAILED(hr))
    //{
    //    MessageBox(NULL, "设置登录类型和运行权限失败!", "Error", MB_OK);
    //    return FALSE;
    //}
    // 设置登录类型
   ...
   // if (FAILED(hr))
   // {
    //    MessageBox(NULL, "设置其他信息失败!", "Error", MB_OK);
    //    return FALSE;
    //}
    // 设置其他信息
    ...
    //if (FAILED(hr))
    //{
    //    MessageBox(NULL, "创建执行动作失败!", "Error", MB_OK);
   //     return FALSE;
    //}
   ...
   //     MessageBox(NULL, "创建执行动作失败!", "Error", MB_OK);
    ...
    //if (FAILED(hr))
    //{
    //    MessageBox(NULL, "设置触发器信息失败!", "Error", MB_OK);
    //    return FALSE;
    //}
    // 创建触发器
   ...
   // if (FAILED(hr))
   // {
    //    MessageBox(NULL, "创建触发器失败!", "Error", MB_OK);
    //    return FALSE;
    //}
    // 注册任务计划
   ...
   // {
    ...
    //    MessageBox(NULL, "注册任务计划失败!", "Error", MB_OK);
    //    return FALSE;
   // }
    pTaskDefinition->Release();
